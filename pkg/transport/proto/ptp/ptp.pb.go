...
type TransportOutbound struct {
	...
	Metadata map[string]string `protobuf:"bytes,1,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Check the protocol type. If it is the BFIA protocol, skip the CDR check.
	Payload  []byte            `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"`                                                                                           // Binary message
	Code     string            `protobuf:"bytes,3,opt,name=code,proto3" json:"code,omitempty"`                                                                                                 // Status code
	Message  string            `protobuf:"bytes,4,opt,name=message,proto3" json:"message,omitempty"`                                                                                           // Status Description
}
...
var file_ptp_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x70, 0x63, 0x2e, 0x70, 0x74, 0x70, 0x22, 0xe2, 0x01, 0x0a, 0x11, 0x54, 0x72, 0x61,
	...
	0x32, 0x2c, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x70, 0x70, 0x63, 0x2e, 0x70, 0x74, 0x70, 0x2e, 0x54,
	...
	0x61, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	...
	0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x6b, 0x75, 0x73, 0x63, 0x69, 0x61, 0x2f, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x74,
...
var file_ptp_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_ptp_proto_goTypes = []interface{}{
	(*TransportOutbound)(nil), // 0: org.ppc.ptp.TransportOutbound
	nil,                       // 1: org.ppc.ptp.TransportOutbound.MetadataEntry
}
var file_ptp_proto_depIdxs = []int32{
	1, // 0: org.ppc.ptp.TransportOutbound.metadata:type_name -> org.ppc.ptp.TransportOutbound.MetadataEntry
